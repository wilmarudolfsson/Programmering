...
ttk.Button(mainframe, text="Kalkylera", command=calculate).grid(column=3, row=3, sticky="W")

ttk.Label(mainframe, text="feet").grid(column=3, row=1, sticky=W)
ttk.Label(mainframe, text="är lika med").grid(column=1, row=2, sticky=E)
